...
namespace Shape {
	...
	Mesh<VertexNormalTex> makeCubeWithPosNormalTexcoords() {
		std::vector<VertexNormalTex> vertexArr;
		for (size_t i = 0; i < vertices.size(); i += VertexNormalTex::layout.back()) {
	...
	Mesh<VertexNormalTex> makePlane() {
		std::vector<VertexNormalTex> vertexArr;
