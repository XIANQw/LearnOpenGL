...
class Cube : public GameObj {

public:
	Cube(const std::vector<float>& vertices,
		const std::vector<uint32_t>& vertexAttrLayout,
		const std::vector<uint32_t>& indices) :
		GameObj(vertices, vertexAttrLayout, indices) {}

	Cube static makeCubeWithPosNormalTexcoords() {
		std::vector<float> vertices{
		...
		std::vector<uint32_t> vertexAttrLayout{ 0, 3, 6, 8};
		std::vector<uint32_t> indices{};

		return Cube(vertices, vertexAttrLayout, indices);
	}
	Cube static makeCubeWithPosNormal(){
		std::vector<float> vertices{
		...
		std::vector<uint32_t> vertexAttrLayout{ 0, 3, 6 };
		std::vector<uint32_t> indices{};

		GameObj obj(vertices, vertexAttrLayout, indices);
	}
	
	Cube static makeCubeWithPosTexcoord(){
		std::vector<float> vertices{
	...
	Cube static makeCube(){
		...
		std::vector<uint32_t> vertexAttrLayout{ 0, 3 };
		std::vector<uint32_t> indices{};
